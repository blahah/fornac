...
export function FornaContainer(element, passedOptions) {
  ...
  var fill = d3.scaleOrdinal(d3.schemeCategory10); // formerly 20
  ...
  */
  ...
  var nodeMouseclick = function(event, d) {
  ...
  self.update = function () {
    ...
    var colors =  d3.scaleOrdinal(d3.schemeCategory10).domain(domain);
